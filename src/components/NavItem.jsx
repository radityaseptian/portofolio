...
export default function NavItem({ children, href, delay, icon: Icon }) {
  ...
  return (
    ...
    >
      <Link
        to={href}
        className="relative flex justify-center items-center gap-1 py-1 after:content-[''] after:absolute after:w-0 after:h-[.20rem] after:-bottom-[.020rem] after:bg-black group-hover:after:w-full after:rounded after:transition-all after:duration-700"
      >
        <Icon className='icon' />
        <span>{children}</span>
      </Link>
